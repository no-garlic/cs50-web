...
urlpatterns = [
    ...
    path("auctions/bid", views_auction.place_bid, name="place_bid"),            # place a bid on an auction
    path("auctions/comment", views_auction.add_comment, name="add_comment"),    # add a comment to an auction
    path("auctions/watch", views_auction.toggle_watchlist, name="watch"),       # add or remove an auction from the watchlist
    path("auctions/close", views_auction.close_auction, name="close_auction"),  # close an auction
]
